                    ...
                    <div
                      className={
                        date >= props.startDate && date <= props.endDate
                          ? "flex place-content-center p-2 bg-gray-200"
                      ...
                      <button
                        className={
                          isDateEqual(date, props.startDate)
                            ? "bg-red-400 h-4 w-4 p-2 rounded-full border-0 text-sm text-center text-white"
                            : isDateEqual(date, props.endDate)
                            ? "bg-red-400 h-4 w-4 p-2 rounded-full border-0 text-sm text-center text-white"
                            : "h-4 w-4 p-2 border-0 text-sm text-center disabled:"
                        }
    ...
    <div className={props.className} ref={outsideRef}>
      <div className="flex w-[100%] h-[100%]">
        <div
          className={
            onStartDate
              ? "flex flex-initial w-[100%] h-[100%] border-2 rounded-full hover:shadow-md"
      ...
      {onStartDate || onEndDate ? (
        <div className="relative w-[848px] m-3 bg-white rounded-lg z-10">
