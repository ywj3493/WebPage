  ...
  return (
    <div className={props.className} ref={outsideRef}>
      <div className="flex w-full h-[64px] self-center">
        <div
          className={classnames(
            `flex flex-initial w-full h-[64px] rounded-full justify-between hover:shadow-md ${
              onStartDate ? `border-2` : ``
            }`
          )}
        >
          <div className="flex flex-col mx-6 my-2 justify-center">
          ...
          {startDate && onStartDate ? (
            <button
              className="mx-6 my-4 rounded-full aspect-square bg-slate-200"
