                      ...
                      <button
                        className={
                          isDateEqual(date, props.startDate)
                            ? "bg-red-400 h-4 w-4 p-2 rounded-full border-0 text-sm text-center text-white disabled:text-white"
                            : isDateEqual(date, props.endDate)
                            ? "bg-red-400 h-4 w-4 p-2 rounded-full border-0 text-sm text-center text-white disabled:text-white"
                            : "h-4 w-4 p-2 rounded-full border-0 text-sm text-center disabled:text-white"
                        }
    ...
    <div className={props.className} ref={outsideRef}>
      <div className="flex w-[100%] h-[100%]">
        <div
          className={
            onStartDate
              ? "flex flex-initial w-[170px] h-[100%] border-2 rounded-full hover:shadow-md"
              : "flex flex-initial w-[170px] h-[100%] rounded-full hover:shadow-md"
          }
        >
      ...
      {onStartDate || onEndDate ? (
        <div className="w-[848px] m-3 bg-white rounded-lg">
          <div className="flex">
            <button className="flex-initial m-3" onClick={onClickPrevMonth}>
              &lt;
            </button>
