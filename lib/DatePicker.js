                  ...
                  return date.getDate ? (
                    <td>
                      ...
                      >
                        <button
                          className={classnames(
                            `h-4 w-4 p-2 border-0 self-center text-sm disabled:text-gray-400 ${
...
function RangeDatePicker(props) {
  ...
  return (
    <div className={props.className} ref={outsideRef}>
      <div className="flex w-[100%] h-[100%] self-center">
        <div
          className={classnames(
            `flex flex-row flex-initial w-[100%] h-[100%] rounded-full hover:shadow-md ${
        ...
        >
          ...
          {startDate && onStartDate ? (
            <button
              className="self-center m-1 w-[24px] h-[24px] rounded-full bg-slate-400"
      ...
      {onStartDate || onEndDate ? (
        <div className="flex flex-col w-[850px] m-3 bg-white rounded-lg z-10 self-center">
